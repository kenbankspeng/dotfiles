		...
		<Svg viewBox="0 0 86 222" {...props}>
			...
			<defs>
				<linearGradient
					...
					y1="0"
					y2=".004"
					gradientTransform="matrix(-.43095 132.669 -92.1319 -.55865 85.43 575.664)"
					gradientUnits="userSpaceOnUse"
				>
					<stop offset="0" style={{ stopColor: "red", stopOpacity: 1 }} />
					<stop offset=".12" style={{ stopColor: "#ffa100", stopOpacity: 1 }} />
					<stop offset=".22" style={{ stopColor: "#00a900", stopOpacity: 1 }} />
					<stop offset=".4" style={{ stopColor: "#0f0", stopOpacity: 1 }} />
					<stop offset=".6" style={{ stopColor: "#2d83b9", stopOpacity: 1 }} />
					<stop offset=".71" style={{ stopColor: "#2f3aec", stopOpacity: 1 }} />
					<stop offset=".8" style={{ stopColor: "#301fff", stopOpacity: 1 }} />
					<stop offset=".89" style={{ stopColor: "#665af4", stopOpacity: 1 }} />
					<stop offset="1" style={{ stopColor: "#ddd", stopOpacity: 1 }} />
				</linearGradient>
			</defs>
		</Svg>
	);
