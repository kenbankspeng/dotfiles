...
export WORKSPACE_ODD_BACKGROUND=0xff2c2e4e
export WORKSPACE_ODD_FOREGROUND=0xff7276a3
export WORKSPACE_EVEN_BACKGROUND=0xff4e4c2c
export WORKSPACE_EVEN_FOREGROUND=0xff807d4c
export WORKSPACE_FOCUSED_BACKGROUND=0xff508869
export WORKSPACE_FOCUSED_FOREGROUND=0xffc9f2d9
